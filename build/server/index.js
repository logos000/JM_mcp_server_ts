...
// 初始化简化下载器
const simpleDownloader = new simple_jm_downloader_js_1.SimpleJMDownloader(configManager.getConfig().dir_rule?.base_dir || './downloads');
// 定义验证规则
...
Returns:
    ...
    album_ids: zod_1.z.array(StringSchema).describe("Array of album IDs to download"),
